...
if __name__ == "__main__":
    ...
    execute_work(process=' com.houbank.houbankfinance', dir=out_path + "\\" + dir, historyFileName=out_mem_history_file, abstractFileName=out_mem_abstract_file, interval=interval)
